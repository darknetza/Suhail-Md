...
global.caption = process.env.CAPTION || global.caption || "DarknetMODZ" 
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "ditsman203",
  packname: process.env.PACK_NAME || "Tap",
  botname : process.env.BOT_NAME  || "DARKNET MD",
  ownername:process.env.OWNER_NAME|| "techzim",
